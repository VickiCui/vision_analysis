...
def process_args():
    ...
    # Special Bert
    parser.add_argument("--syn_w", default=0.3, type=float, help="Weight for syntagmatic loss.")
    parser.add_argument("--lda_data", action="store_true", help="Using the lda dataset object in data.py")
    parser.add_argument("--lda_dir", default=None, type=str, help="Where the LDA are saved.")
    parser.add_argument("--topic_num", default=192, type=int, help="Topic number for LDA.")
