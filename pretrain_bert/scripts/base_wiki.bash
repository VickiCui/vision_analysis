...
export TRAIN_FILE=data/wiki/en.train.raw
export TEST_FILE=data/wiki/en.valid.raw
...
CUDA_VISIBLE_DEVICES=$GPUS unbuffer python src/run_lm_distributed.py \
    ...
    --model_name_or_path=/data/home/lanyanyan/cuiwanqing/code/vision_analysis/pretrained_models/bert-base-uncased \
    --model_type=bert \
	--block_size=126 \
